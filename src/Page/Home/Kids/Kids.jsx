...
const Kids= () => {
    ...
    useEffect(() => {
        fetch('http://localhost:5000/bestkids')
            .then(res => res.json())
    ...
    return (
        <>
            <h1 className='text-center text-4xl'>Best Seller kids Books</h1>
                    ...
                    {kidsBooks.map((kidsBook) => (
                        <div key={kidsBook._id} className='inline-block'>
                            ...
                            <h2 className='w-[250px] h-[150px] text-xl text-center overflow-hidden whitespace-normal'>
                                <Link to={`/kids/${kidsBook._id}`} className='text-xl'>{kidsBook.name}</Link>
                            </h2>
                        </div>
                    ))}
                </div>
            ...
            <div>
                <h1 className='text-center text-4xl'>All kids Books</h1>        </div>
